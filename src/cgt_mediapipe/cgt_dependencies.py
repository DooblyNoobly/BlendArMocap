...
if sys.platform == 'darwin' and platform.processor() == 'arm':
    required_dependencies = [
        ...
        Dependency(module="mediapipe-silicon==0.10.14", name="mediapipe", pkg="mediapipe-silicon", args=None)
    ]
    ...
    required_dependencies = [
        Dependency(module="opencv-contrib-python==4.7.0.68", name="cv2", pkg="opencv_contrib_python", args=None),
        Dependency(module="protobuf==3.20.3", name="google.protobuf", pkg="protobuf", args=None),
        Dependency(module="mediapipe==0.10.14", name="mediapipe", pkg="mediapipe", args=None)
    ]
...
# legacy mac
    ...
    required_dependencies = [
        ...
        Dependency(module="mediapipe==0.10.14", name="mediapipe", pkg="mediapipe", args=["--no-deps"]),
    ]
